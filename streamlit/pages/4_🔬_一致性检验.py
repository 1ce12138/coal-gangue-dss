...
st.set_page_config(page_title=f"一致性检验 | {APP_TITLE}", page_icon="🔬", layout="wide")
...
st.markdown('<div class="main-title"><h1>一致性检验</h1><p>人工专家评分与 AI 评分的一致性验证</p></div>', unsafe_allow_html=True)
